		...
		<div class="container"> 
			<div class="account-bottom">
				<div class="col-md-6 account-left">
					...
					<div class="address">
						<span>Nombre</span>
						<input type="text" id="Nombre" name="Nombre" required=""  pattern="[A-Za-z]+" maxlength="20">
					</div>
					<div class="address">
...
echo "'<option value= $valores[idGenero]> $valores[Genero] </option>'";
            ...
            ?>
					...
					<div class="address">
						Fecha de Nacimiento: <input type="date" id="FechaN" name="FechaN" required=""> <p></p>
					</div>
					<div>
					...
					<div class="address">
						...
						<input type="text" name="Correo" id="Correo" required="" pattern="[A-Za-z@.]+">
					</div>
					...
					<div class="rol">
						Rol: <select name="Rol" id="Rol"  style="height: 40px; width: 50%;" required=""> 
						<p></p>
           <?php
           error_reporting(E_ALL^E_NOTICE);
           include('Conexion.php');
           $ConsultaRol= "select * from rol where not idRol=3";
           $RCRol=mysqli_query($conect,$ConsultaRol)  or die("error al consultar los datos
del usuario");   
while ($valores=mysqli_fetch_array($RCRol)){
            ...
            ?>
				...
				<div class="col-md-6 account-left">
					...
					<div class="address">
						...
						<input type="number" id="NumeroI" name="NumeroI" required="" style="width: 540px; height: 45px; border-color: black; border-width: 1px;" required pattern="[0-9-A-Z-a-z]+" maxlength="6">
					</div>
					<div class="address">
					...
					<div class="address">
						...
						<input type="text" name="NumeroE" name="NumeroE" required="" pattern="[0-9-A-Z-a-z]+" maxlength="6" >
					</div>
							<div class="address">
						<span>Estado:</span>
				...
				<div class="address new">
						<input type="submit" value="Registrarse" id="Registro" name="Registro" style="margin: 25px;" required=""onclick="return confirm('El usuario fue registrado con exito');">
					</div>
						</form>
				<div class="clearfix"> </div>
			</div>
...
'$NumeroI',$CodigoPostal,'$NumeroE',1,NULL,NULL, '$Telefono','$Correo','$Contrasena',$Rol)";
