...
<body> 
	...
	error_reporting(E_ALL^E_NOTICE);
		if(!$_GET)
		{
			header('Location:IndexEditor.php?pagina=1');
		}
  ...
  if(valor.value != "" ){
    ...
    document.getElementById("buscar").disabled = "disabled"; 
			...
			<!-- logo de la empresa -->
				<a href="IndexEditor.php"><img src="images/logo-4.png" alt="" /></a>
			</div>
			<!--Carrito de compras-->
		...
		<div class="container">
			<div class="top-nav">
				<ul class="memenu skyblue"><li class="active"><a href="IndexEditor.php">Inicio</a></li>
					<li class="grid"><a href="Mi_PerfilEditor.php">Mi perfil</a>
					</li> 					
		...
		?>
				<ul class="cart-header">
					<div> </div>
						...
						<li><span><button onclick="location.href='editarProductos2.php?id=<?php echo $idProducto; ?>'">Modificar</button></span></li>
					<div class="clearfix"> </div>
				</ul>
		<?php
...
<!-- **Inicio de la paginacion-->
		<div align= "center">
			<ul class="pagination">
				<li class="<?php echo $_GET['pagina']<=1 ? 'disabled':''?>"><a href="IndexEditor.php?pagina=<?php echo $_GET['pagina']-1?>">Anterior</a></li>
				<?php
				for ($i=0; $i<$pagina; $i++)
				{
				?>
					<li class="<?php echo $_GET['pagina']==$i+1 ? 'active' : ''?>"><a href="IndexEditor.php?pagina=<?php echo $i+1 ?>"><?php echo $i+1 ?></a></li>
				<?php
				}
				?>
				<li class="<?php echo $_GET['pagina']>= $pagina ? 'disabled':'' ?>"><a href="IndexEditor.php?pagina=<?php echo $_GET['pagina']+1?>">Siguiente</a></li>
			</ul>
		</div>
